...
export const KNOWLEDGE_HUB: KnowledgeModule[] = [
  ...
  { id: "500", category: "System", title: "Infrastructure Scale", summary: "500 Verified Modules.", details: "The Islamly system now hosts 500+ verified scholarly modules strictly aligned with the Sunnah." }
];
