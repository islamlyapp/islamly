...
export const KNOWLEDGE_HUB: KnowledgeModule[] = [
  ...
  { id: "1000", category: "System", title: "Universal Infrastructure", summary: "Scholarly Infrastructure Active.", details: "The Islamly system is engineered to handle granular scholarly interaction, ensuring every Mas'alah (issue) is cataloged with evidence." }
];
