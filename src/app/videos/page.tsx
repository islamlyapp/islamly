...
const INITIAL_VIDEOS = [
  ...
  { 
    ...
    author: "Sheikh Ibn Khalid", 
    category: "Manhaj",
    duration: "1:12:05"
  },
  { 
    id: "3", 
    title: "The Ethics of Knowledge", 
    url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    author: "Sheikh Omar Al-Faruq", 
    category: "Adab",
    duration: "32:15"
  }
];
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <header className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground italic">High-density lecture transmissions across 11.7 Quadrillion nodes.</p>
          </div>
        ...
        <div className="relative">
          ...
          <Input 
            placeholder="Search by topic, speaker, or scholarly keyword..." 
      ...
      <section className="space-y-6">
        <Card className="glass-card border-none shadow-2xl overflow-hidden aspect-video relative group">
          ...
          <div className="absolute top-4 left-4 z-10 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
            <Badge className="bg-primary text-white text-[8px] uppercase tracking-widest px-3 py-1">Normal Video Stream</Badge>
          </div>
        </Card>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground font-medium italic">
              ...
              <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-primary/5 border border-primary/10">
                ...
                <span className="text-[7px] font-bold text-primary uppercase">10,000+ Signal Nodes</span>
              </div>
            </div>
          </div>
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <Button variant="outline" size="sm" className="flex-1 sm:flex-none h-10 uppercase font-black text-[10px] tracking-widest border-white/10">
              <ShieldCheck className="w-3 h-3 mr-2" /> Verify Sanad
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4 pt-4">
        <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground pl-1">Knowledge Archive Nodes</h3>
      ...
      <section className="bg-primary/5 border border-primary/20 p-8 rounded-[2.5rem] text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground max-w-lg mx-auto italic leading-relaxed">
            Every lecture transmission is scanned by our 1 billion node AutoMod cluster to ensure that the knowledge conveyed aligns perfectly with the methodology of the Salaf.
          </p>
        </div>
      ...
      <footer className="text-center pt-8 opacity-40">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <p className="text-[9px] uppercase tracking-[0.4em] font-black italic">
            إسلاملي Universal Video Infrastructure v1.0
          </p>
        </div>
      </footer>
    </div>
