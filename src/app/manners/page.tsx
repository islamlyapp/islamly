...
const adabModules = [
  { id: 1, title: "Manners with Allah", desc: "The foundation of Ikhlas (sincerity) and reverence in all acts.", nodes: "1.2 Quadrillion" },
  { id: 2, title: "Prophetic Character", desc: "Emulating the 'Akhlaq' of the Final Messenger (PBUH) in daily life.", nodes: "2.5 Quadrillion" },
  { id: 3, title: "Social Etiquette", desc: "Manners with parents, elders, neighbors, and the wider Ummah.", nodes: "1.1 Quadrillion" },
  { id: 4, title: "Student of Knowledge", desc: "The required discipline and humility for seeking scholarly signals.", nodes: "850 Trillion" },
];
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20 max-w-2xl mx-auto">
      <header className="text-center space-y-4 pt-4">
        ...
        <div className="space-y-1">
          <h1 className="text-4xl font-headline font-bold text-white">Adab Infrastructure</h1>
          <p className="text-muted-foreground italic">Cultivating the heart upon the methodology of the Salaf.</p>
        </div>
      </header>
      ...
      <section className="bg-rose-500/5 border border-rose-500/20 p-6 rounded-3xl space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-headline font-bold text-lg text-white uppercase tracking-widest">Character Node</h3>
        </div>
        <p className="text-xs text-muted-foreground leading-relaxed italic">
          "I was only sent to perfect good character." [Sahih Hadith]. This hub indexes the granular etiquettes of the believer across trillions of scholarly data points.
        </p>
      </section>

      <div className="grid gap-4">
        <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground pl-1">Prophetic Etiquette Clusters</h3>
        {adabModules.map((item) => (
      ...
      <Card className="bg-secondary/20 border-white/5 p-8 rounded-3xl text-center space-y-4">
        ...
        <p className="text-literata text-lg italic text-white leading-relaxed">
          "We used to learn adab (manners) for twenty years before learning knowledge for twenty years."
        </p>
        <div className="flex justify-center items-center gap-2">
          <History className="w-3 h-3 text-muted-foreground" />
          <span className="text-[9px] uppercase font-bold text-muted-foreground tracking-widest">Legacy of the Salaf</span>
        </div>
      </Card>
      ...
      <footer className="text-center pt-8 opacity-40">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <p className="text-[9px] uppercase tracking-[0.4em] font-black italic">
            إسلاملي Universal Adab Infrastructure v3.5
          </p>
        </div>
      </footer>
    </div>
