...
const playlists = [
  ...
  { id: 2, title: "Purification of the Heart", speaker: "Sh. Ahmad", duration: "32:10", category: "Tazkiyah" },
  { id: 3, title: "Fiqh Masterclass", speaker: "Ust. Omar", duration: "1:12:00", category: "Fiqh" },
  { id: 4, title: "Prophetic Manners", speaker: "Sh. Hassan", duration: "28:45", category: "Adab" },
];
      ...
      <Card className="bg-gradient-to-br from-primary/20 to-secondary border-primary/20 overflow-hidden shadow-2xl relative group">
        ...
        <CardContent className="p-8 relative z-10 space-y-6">
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="w-48 h-48 rounded-2xl bg-black/40 flex items-center justify-center border border-white/10 shrink-0 relative overflow-hidden">
